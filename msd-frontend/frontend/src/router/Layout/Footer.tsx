...
export default function Footer(infoFooter: infoFooter) {
    ...
    return (
        ...
        //         </p>
        //     </div>
        <div className="flex lg:relative lg:z-50 justify-center lg:justify-start w-full h-fit pt-1 pb-2 lg:pt-4 lg:pb-4 pr-6 lg:pr-5 lg:pl-5 xxl:pl-7 xxl:pr-7 mt-auto">
            <h1 className={`text-${colorText} font-Alexandria text-center lg:text-left text-[7px] sm:text-[9px] md:text-[10px] lg:text-[16px] xl:text-[18px] lg:leading-[25px] fs-footer-mac15`}
                style={{ color: colorText }} dangerouslySetInnerHTML={convertHTML(sloganText)}>
