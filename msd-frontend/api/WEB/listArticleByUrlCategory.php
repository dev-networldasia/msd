...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
                $stmt_total = $conn->prepare($getSQL['gNewsByNewsCategoryUrl'] . " ORDER BY news.id DESC");
                ...
                $stmt = $conn->prepare($getSQL['gNewsByNewsCategoryUrl'] . " ORDER BY news.id DESC" . " LIMIT $limit OFFSET $offset");
